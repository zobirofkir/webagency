<x-app-layout>
    ...
    <section id="features" class="relative z-10 pt-[110px]">
        ...
        >
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                ...
                >
                <div
                    class="mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl bg-gray text-primary duration-300 group-hover:bg-primary group-hover:text-white dark:bg-[#ffffff] dark:text-black dark:group-hover:bg-primary"
                >
                    <svg
                    width="44"
                    height="44"
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                ...
                <h3
                    class="mb-4 text-xl font-semibold text-white dark:text-black sm:text-[22px] xl:text-[26px]"
                >
        ...
        <div
        class="absolute left-0 -bottom-1/2 -z-10 hidden md:block"
        >
        <svg
            width="622"
            height="1236"
    ...
    <section id="work-process" class="relative z-10 pt-[110px]">
        ...
        <!-- Graphics -->
        <div
        class="absolute -top-28 left-0 -z-10 hidden md:block"
        >
        <svg
            width="632"
            height="1179"
    ...
    <section id="pricing" class="relative z-10 pt-[110px]">
        ...
        >
            ...
            <span
                class="mx-5 flex h-[34px] w-[60px] cursor-pointer items-center rounded-full bg-primary p-[3px]"
            >
                <span
                class="dot block h-7 w-7 rounded-full bg-white duration-300"
                ></span>
            </span>
            <span
                class="yearly text-sm font-medium text-black dark:text-white"
            >
                Yearly
            </span>
            </label>
        ...
        <div class="-mx-6 flex flex-wrap justify-center">
            ...
            <div
                class="wow fadeInUp mb-10 rounded-xl bg-white py-10 px-9 shadow-card dark:bg-dark dark:shadow-card-dark lg:mb-4 lg:px-7 xl:px-9"
                data-wow-delay=".2s"
            >
                <h3
                class="mb-2 text-[22px] font-semibold leading-tight text-black dark:text-white"
                >
                Free
                </h3>
                ...
                <p
                class="border-b border-stroke pb-5 text-black dark:border-stroke-dark dark:text-white"
                >
                ...
                <p
                    class="flex text-base text-black dark:text-body"
                >
                ...
                <a
                href="javascript:void(0)"
                class="block w-full rounded-md bg-black py-[10px] px-8 text-center text-base font-medium text-white hover:bg-primary dark:bg-[#ffffff] dark:hover:bg-primary"
                >
                Choose Plan
                </a>
            </div>
            ...
            <div class="w-full px-6 md:w-1/2 lg:w-1/3">
            <div
                class="wow fadeInUp relative mb-10 rounded-xl bg-white py-10 px-9 shadow-card dark:bg-dark dark:shadow-card-dark lg:mb-4 lg:px-7 xl:px-9"
                data-wow-delay=".3s"
            >
                <span
                class="absolute top-5 right-5 text-sm font-medium text-primary underline"
                >
                Most popular
                </span>
                <h3
    ...
    <section id="screens" class="relative z-20 pt-[110px]">
        ...
        <div class="container">
        <div
            class="wow fadeInUp mx-auto max-w-[1000px]"
            data-wow-delay=".2s"
        >
            <!-- Swiper -->
            ...
            >
                <img
                src="{{asset('assets/images/mobile-frame.png')}}"
                alt="mobile-frame"
                class="mx-auto max-w-full"
                />
            </div>
            <div class="swiper-wrapper py-2">
                ...
                >
                    <img
                    src="{{asset('assets/images/screen-1-light.png')}}"
                    alt="screenshot"
                ...
                >
                    <img
                    src="{{asset('assets/images/screen-2-light.png')}}"
                    alt="screenshot"
                    class="mx-auto w-full rounded-2xl"
                    />
                </div>
                ...
                >
                    <img
                    src="{{asset('assets/images/screen-3-light.png')}}"
                    alt="screenshot"
                    class="mx-auto w-full rounded-2xl"
                    />
                </div>
    ...
    <section id="cta" class="relative z-10 pt-[110px]">
        ...
        >
            ...
            <div class="w-full px-4 lg:w-1/2">
                ...
                >
                <img
                    src="{{asset('assets/images/cta-light.png')}}"
                    alt="cta image"
                    class="mx-auto max-w-full"
                />
                <div
                    class="absolute -top-5 left-0 right-0 -z-10 aspect-square w-full rounded-full bg-gradient-2"
                ></div>
                <div class="absolute top-0 right-0 -z-10">
                    <svg
                    width="60"
        ...
        <div
        class="absolute left-0 top-10 -z-10 hidden sm:block"
        >
        <svg
            width="706"
            height="1405"
    ...
    <section
        id="testimonials"
        class="relative z-10 pt-[110px] pb-[60px]"
    >
        <div class="container">
        <div
            class="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
        ...
        <div class="-mx-6 flex flex-wrap">
            ...
            <div
                class="wow fadeInUp mb-[50px] rounded-lg bg-white py-9 px-7 shadow-card dark:bg-dark dark:shadow-card-dark sm:px-9 lg:px-7 xl:px-9"
                data-wow-delay=".2s"
            >
                <div
                class="mb-5 border-b border-stroke dark:border-stroke-dark"
                >
                ...
                <div
                class="items-center justify-between sm:flex lg:block xl:flex"
                >
                <div
                    class="mb-4 flex items-center sm:mb-0 lg:mb-4 xl:mb-0"
                >
                    <div
                    class="mr-4 h-[56px] w-full max-w-[56px] rounded-full"
                    >
                    <img
                        src="{{asset('assets/images/author-1.png')}}"
                        alt="author"
                    ...
                    <div>
                    <h5
                        class="text-base font-medium text-black dark:text-black"
                    >
                        Musharof Chowdhury
                    </h5>
                ...
                <div
                    class="flex items-center space-x-3 sm:justify-end lg:justify-start xl:justify-end"
                >
                    <p
                    class="text-base font-medium text-black dark:text-black"
                    >
            ...
            >
                ...
                >
                    ...
                    >
                    <img
                        src="{{asset('assets/images/author-2.png')}}"
                        alt="author"
                        class="h-full w-full object-cover object-center"
                    />
                    </div>
            ...
            >
                ...
                >
                    ...
                    >
                    <img
                        src="{{asset('assets/images/author-3.png')}}"
                        alt="author"
                        class="h-full w-full object-cover object-center"
                    />
                    </div>
            ...
            >
                ...
                >
                    ...
                    >
                    <img
                        src="{{asset('assets/images/author-04.png')}}"
                        alt="author"
                        class="h-full w-full object-cover object-center"
                    />
                    </div>
    ...
    <section
        id="faq"
        class="relative z-10 bg-[#F8FAFB] py-[110px] dark:bg-[#15182B]"
    >
        <div class="container">
        <div
            class="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
        ...
        >
            <div
            class="faq border-b border-stroke last-of-type:border-none dark:border-stroke-dark"
            >
            <button
                class="faq-btn relative flex w-full justify-between py-6 px-[18px] text-left text-base font-medium text-black dark:text-black sm:px-[26px] sm:text-lg"
            >
    ...
    <!-- ======= Blog Start ======= -->
    <section id="blog" class="pt-[110px] pb-[60px]">
        <div class="container">
        <div
            class="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]"
            data-wow-delay=".2s"
        ...
        <div
            class="-mx-4 flex flex-wrap justify-center md:-mx-7 lg:-mx-5 xl:-mx-[35px]"
        >
            <div
            class="w-full px-4 md:w-1/2 md:px-7 lg:w-1/3 lg:px-5 xl:px-[35px]"
            >
            <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
                <div class="relative overflow-hidden rounded">
                <img
                    src="{{asset('assets/images/blog-01.jpg')}}"
                    alt="blog post"
                ...
                >
                    ...
                    <p
                        class="mt-3 flex items-center px-[10px] text-base font-medium text-white"
                    >
                        <span class="mr-2">
                        <svg
                            width="18"
                ...
                <h3>
                    <a
                    href="#"
                    class="mb-3 inline-block text-xl font-semibold text-black hover:text-primary dark:text-black dark:hover:text-primary sm:text-2xl lg:text-xl xl:text-2xl"
                    >
    ...
    >
        ...
        >
            ...
            <div class="mb-5 text-center">
                ...
                <img
                    src="{{asset('assets/images/client-01.svg')}}"
                    alt="client"
            ...
            <div class="mb-5 text-center">
                <a href="javascript:void(0)" class="block">
                <img
                    src="{{asset('assets/images/client-02.svg')}}"
                    alt="client"
                    class="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                />
                </a>
            ...
            <div class="mb-5 text-center">
                <a href="javascript:void(0)" class="block">
                <img
                    src="{{asset('assets/images/client-03.svg')}}"
                    alt="client"
                    class="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                />
                </a>
            ...
            <div class="mb-5 text-center">
                <a href="javascript:void(0)" class="block">
                <img
                    src="{{asset('assets/images/client-04.svg')}}"
                    alt="client"
                    class="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                />
                </a>
            ...
            <div class="mb-5 text-center">
                <a href="javascript:void(0)" class="block">
                <img
                    src="{{asset('assets/images/client-05.svg')}}"
                    alt="client"
                    class="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                />
                </a>
            ...
            <div class="mb-5 text-center">
                <a href="javascript:void(0)" class="block">
                <img
                    src="{{asset('assets/images/client-06.svg')}}"
                    alt="client"
                    class="mx-auto max-w-full opacity-[65%] hover:opacity-100"
                />
                </a>
        ...
        >
            ...
            <div class="-mx-[22px] flex flex-wrap">
                ...
                <div class="mb-8">
                    ...
                    class="w-full rounded border border-stroke bg-white py-4 px-[30px] text-base text-body outline-none focus:border-primary dark:border-[#34374A] dark:bg-[#ffffff] dark:focus:border-primary"
                    />
                </div>
                </div>
